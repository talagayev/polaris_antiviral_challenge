...
DATA_PATH = '/mdspace/polaris_ml_challenge/data/potency/UNBLINDED_DATA/train_data_sars.csv'
...
def prepare_data_with_fingerprints(path, fp_config):
    ...
    data.rename(columns={'pIC50 (SARS-CoV-2 Mpro)': 'pIC50'}, inplace=True)
...
if __name__ == "__main__":
    ...
    print("\nSaving final model...")
    torch.save(final_model.state_dict(), 'SARS_potency_BNN_model_final_all_data.pth')
    ...
    with open('SARS_potency_BNN_complete_config_final.json', 'w') as f:
